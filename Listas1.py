...
# al definir nombres como una lista, ya puedo llamar a cualquiera de los métodos que se aplicarán sobre listas.
...
print(nombres)
# fíjate que el método se llama en la lista concreta sobre la que se quiere usar, NO se pone lista.append, sino nombres.append
...
posicion = int(input())
nombres.insert(posicion,nuevo) #inserta elemento en la posición dada; ojo a la numeración, que empieza en cero.
print(nombres)
